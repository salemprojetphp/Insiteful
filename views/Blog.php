...
<head>
    ...
    <link rel="icon" href="image/insiteful.png">
    ...
    <section class="all">
        ...
        <main class="flex">
            ...
            <div class="content"> 
                ...
                <div class="blog-description gray mb24">
                No more inline javascript needed
                </div>
                <div class="blog-article-content-info flex caption gray">
                <div class="flex">
                <img src="../public/images/user.png" width="24" height="24" alt="author"><span class="ml8 mr24">Irae Hueck Costa</span>
                Sep 18, 2022
                </div>
                <div class="flex">
                <!-- like dislike comment btns  -->
