...
<body>
    ...
    <section class="settings">
        <select onchange=<?php ?> id="website-select">
        ...
        <select onchange=<?php ?> id="time-range-select">
    ...
    <section class="categories">
        <div id="visits">
            <h2>
                <?php
                    echo $visitors->getNumberOfVisits(1,"insat.tn");
                ?>
            </h2>
            Visits
        </div>
        <div id="search-engines">
            <h2>
                <?php
                    echo $visitors->getNumberOfSearchEngines(1, "insat.tn");
                ?>
            </h2>
            Search engines
        </div>
        <div id="social-networks">
            <h2>
                <?php
                    echo $visitors->getNumberOfSocialMediaVisits(1,"insat.tn");
                ?>
            </h2>
            Social networks
        </div>
        <div id="direct">
            <h2>
                <?php
                    echo $visitors->getNumberOfDirectVisits(1,"insat.tn");
                ?>
            </h2>
            Direct
        </div>
