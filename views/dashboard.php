    ...
    <section class="categories">
        <div id="visits">
            <h2>
                <?php
                    if(isset($websiteSelected)){
                        echo $visitors->getNumberOfVisits(1,$websiteSelected);
                    }
                    else{
                        echo "???";
                    }
        ...
        <div id="search-engines">
            <h2>
                <?php
                    if(isset($websiteSelected)){
                        echo $visitors->getNumberOfSearchEngines(1, $websiteSelected);
                    }
                    else{
                        echo "???";
                    }
        ...
        <div id="social-networks">
            <h2>
                <?php
                   if(isset($websiteSelected)){
                    echo $visitors->getNumberOfSocialMediaVisits(1,$websiteSelected);
                    }
                    else{
                        echo "???";
                    }
        ...
        <div id="direct">
            <h2>
                <?php
                   if(isset($websiteSelected)){
                        echo $visitors->getNumberOfDirectVisits(1,$websiteSelected);
                    }
                    else{
                        echo "???";
                    }
